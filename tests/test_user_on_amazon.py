...
def test_scrapper_amazon_result_description_count():
    ...
    """
    result = scraper(
        "https://www.amazon.com/Controller-Charger-Charging-Station-Playstation-Stand/dp/B08NF64SD4/ref=sr_1_1_sspa?dchild=1&keywords=NexiGo-Playstation-Console-Controller-Charging&qid=1635977313&sr=8-1-spons&psc=1&spLa=ZW5jcnlwdGVkUXVhbGlmaWVyPUEyNUs0TURYMzI5TzNVJmVuY3J5cHRlZElkPUEwMjAzMDM4TzhIUEFNTElGSTdVJmVuY3J5cHRlZEFkSWQ9QTAxMzcyODgyQ1JQT1hMVzlKMU1MJndpZGdldE5hbWU9c3BfYXRmJmFjdGlvbj1jbGlja1JlZGlyZWN0JmRvTm90TG9nQ2xpY2s9dHJ1ZQ=="
    )
