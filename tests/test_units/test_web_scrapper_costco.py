...
def test_get_url_costco_1():
    ...
    :return: None
    '''
    search_term = "White Diamonds by Elizabeth Taylor 3.3 3.4 oz EDT Perfume for Women New Tester"
    item_name = search_term.replace(" ", "%20")
    assert get_url_costco(item_name) == f"https://www.costco.com//CatalogSearch?dept=All&keyword={item_name}"
